...
<section class="gallery5_section">
  <p class="site_guide">
    isotope(jQuery-plugin)를 이용한 반응형 그리드 레이아웃을 설계하였습니다.
  ...
  <div class="btn_container">
    <button class="active" value="*">all</button>
